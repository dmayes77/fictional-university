      ...
      <div class="container">
        ...
        <div class="site-header__menu group">
          <nav class="main-navigation">
            ...
            <ul>
              <li <?php if (is_page('about-us') || wp_get_post_parent_id(0) == 15) echo 'class="current-menu-item"' ?> ><a href="<?php echo site_url('/about-us')?>">About Us</a></li>
          ...
          <div class="site-header__util">
            <?php if (is_user_logged_in()) { ?>
              ...
              <span class="site-header__avater" ><?php get_avatar(get_current_user_id(), 60); ?></span>
